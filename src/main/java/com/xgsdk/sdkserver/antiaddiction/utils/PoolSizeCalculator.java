package com.xgsdk.sdkserver.antiaddiction.utils;
...
public abstract class PoolSizeCalculator {
    ...
    private void calculateOptimalCapacity(BigDecimal targetQueueSizeBytes) {
        ...
        System.out.println("Formula: " + targetQueueSizeBytes + " / " + mem);System.out.println("* Recommended queue capacity (bytes): "+ queueCapacity);
    }
    /**
